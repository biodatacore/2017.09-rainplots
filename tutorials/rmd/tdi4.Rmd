...
Where $X\beta$ corresponds to other control variables included in the model and $\epsilon \sim \mathcal{N}(0, \sigma^2)$. `estimate` is the estimated value of $\beta_1$ and `p.value` is the corresponding P-value.
